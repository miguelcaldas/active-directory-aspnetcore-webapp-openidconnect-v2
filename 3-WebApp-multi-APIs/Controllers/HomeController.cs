...
namespace WebApp_OpenIDConnect_DotNet.Controllers {
  ...
  public class HomeController: Controller {
    ...
    public HomeController(ITokenAcquisition tokenAcquisition, IGraphApiOperations graphApiOperations, IArmOperations armOperations, IArmOperationsWithImplicitAuth armOperationsWithImplicitAuth) {
    ...
    public async Task<IActionResult> Tenants() {
      ...
      /*
      var tenantsIdsAndNames =  await graphApiOperations.EnumerateTenantsIdAndNameAccessibleByUser(tenantIds, async tenantId => { return await tokenAcquisition.GetAccessTokenForUserAsync(new string[] { "Directory.Read.All" }, tenantId); });
      */
